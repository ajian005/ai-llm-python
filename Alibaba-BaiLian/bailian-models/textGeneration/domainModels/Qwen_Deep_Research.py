"""
大模型服务平台-->百炼用户指南（模型）-->文本生成-->领域模型-->深入研究（Qwen-Deep-Research） :https://help.aliyun.com/zh/model-studio/qwen-deep-research

    wen-Deep-Research 是通义千问的研究型智能体模型。它可拆解复杂问题，结合互联网搜索进行推理分析并生成研究报告。
