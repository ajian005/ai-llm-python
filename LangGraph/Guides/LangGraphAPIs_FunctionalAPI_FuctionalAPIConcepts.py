"""
    Functional API concepts : https://langchain-ai.github.io/langgraph/concepts/functional_api/
...
"""
   ...
   from langgraph.types import Command
    ...
    ====== Entrypoint --> Resuming --> Resuming after an error ============================
...
"""
====== Common Pitfalls --> Handling side effects ============================
...
"""
====== Common Pitfalls --> Non-deterministic control flow ============================
...
-----------Correct----------------------
n this example, the workflow uses the input t0 to determine which task to execute. This is deterministic because the result of the workflow depends only on the input.
