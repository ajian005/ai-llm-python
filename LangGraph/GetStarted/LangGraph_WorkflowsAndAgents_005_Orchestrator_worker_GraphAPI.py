...
graph_image_data = orchestrator_worker.get_graph().draw_mermaid_png()
with open("LangGraph/GetStarted/images/LangGraph_WorkflowsAndAgents_005_Orchestrator_worker_GraphAPI.png", "wb") as f:
    f.write(graph_image_data)
print("Workflow graph saved as 'LangGraph_WorkflowsAndAgents_005_Orchestrator_worker_GraphAPI.png'")
